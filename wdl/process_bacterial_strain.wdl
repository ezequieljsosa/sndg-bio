...
task trimming {
    ...
    command {
        java -jar $TRIMMOMATIC PE -phred33 -threads ${cpus} ${fastq1} ${fastq2} 1.fastq.gz  1U.fastq.gz 2.fastq.gz 2U.fastq.gz HEADCROP:18 \
	...
	TRAILING:3 SLIDINGWINDOW:10:5 MINLEN:36
...
task variant_call {
    ...
    command {
	    ...
	    -R ${reference_dir}/${reference_filename} -ploidy 1 \
	    -I ${alignment_bam} \
	    -O raw.g.vcf.gz
    }
    output {
