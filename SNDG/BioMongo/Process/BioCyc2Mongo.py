...
from Bia.IO.pathways import ChokepointType
from Bia.Model.collections import SeqColDruggabilityParam, \
    SeqColDruggabilityParamTypes
from Bia.Model.pathways import PathwaySumary
from Bia.Model.sequence import Protein, ProteinDruggabilitySearch
from BiaOntology.Model.ontology import Ontology, SeqColOntologyIndex
from BiaOntology.indexer import KeywordIndexer
...
from Bia.Model.collections import SeqColDruggabilityParamTypes 
...
class BioCyc(object):
    ...
    protein_pathway_search_params = [ 
        ("centrality",
         ...
         """,
            ...
            None,
            "max", ">", "0.1"),
        ("chokepoint", "If the protein catalyzes a reaction that is a metabolic chokepoint", "pathways", SeqColDruggabilityParamTypes.value, ["true", "false"],
         "avg", "equal", "true"),
        ("chokepoint_type", "metabolic chokepoint type, can be of consume, production or double", "pathways", SeqColDruggabilityParamTypes.value,
    ...
    pathways_search_params = [ 
        ("reactions", "Number of reactions in the pathway", "pathway", SeqColDruggabilityParamTypes.number, None, "avg", ">", 0),
        ("norm_reactions", "Number of reactions normalized by the highest pathway (with more reactions)", "pathway", SeqColDruggabilityParamTypes.number, None, "avg", ">", 0),
        ("reactions_with_gene", "Number of reactions in the pathway with at least one known protein that catalize them", "pathway", SeqColDruggabilityParamTypes.number, None, "avg", ">", 0),
        ("completeness", "Proportion of reactions in the pathway with at least one known protein that catalize them", "pathway",
            SeqColDruggabilityParamTypes.number, None, "max", ">", 0.8),
        ("chokepoints", "Number of chokepoints reactions in the pathway", "pathway", SeqColDruggabilityParamTypes.number, None, "avg", ">", 0),
        ("norm_chokepoint", "Chokepoint reactions/reactions in pathway ratio", "pathway", SeqColDruggabilityParamTypes.number, None, "avg", ">", 0),
        ("druggable", "The pathway has at least one druggable protein", "pathway", SeqColDruggabilityParamTypes.value, ["Yes", "No"],
         "avg", "equal", "Yes"),
        ("max_centrality", "Maximum betweenness centrality of all the reactions in the pathway, normalized by the reaction with max betweenes centrality in the whole graph",
...
#          SeqColDruggabilityParamTypes.number, None,      "avg", "equal", 0)
    ...
    def _process_proteins(self, genome):
        ...
        for protein in Protein.objects(organism=genome.name, reactions__0__exists=True).no_cache().timeout(False):  # @UndefinedVariable 
            keywords1 = self._protein_keywords(protein)            
            keywords2 = self._add_drugability_props_to_protein(protein)
            protein.keywords = list(set([x.strip().lower() for x in keywords1 + keywords2 + protein.keywords if x.strip()]))
            protein.save()
...
if __name__ == '__main__':  
    bacs = ['666', '85007', '82115', '2093', '482', '914', '203682', '40222', '29', '543', '85011', '816', '28211', '1090', '33882', '286', '85025', '200938', '2062', '2063', '85006', '976', '203691', '194', '193', '192', '32011', '396', '85008', '93681', '919', '91347', '1236', '135613', '1239', '200795', '40117', '188708', '810', '28221', '135617', '85023', '22', '200940', '641', '434', '1279', '1227', '44249', '1224', '629', '72276', '1883', '2', '506', '55158', '191411', '74152', '1293497', '171552', '33877', '135623', '204457', '32066', '186826', '191412', '544448', '724', '200783', '578822', '68336', '91061', '68297', '39773', '200918', '267890', '81', '204441', '28216', '201174', '2037', '67814', '1117', '1118', '817', '1297', '186801', '142182', '200930', '429', '35798', '1046', '204455', '356', '508458', '1762', '1763', '1760', '838']
