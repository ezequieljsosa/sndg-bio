...
Opciones:\n\
	...
	-d 	Base de datos para busqueda de similitud. Default: data/uniprot/uniref50/uniref50.fasta\n\
...
params["d"] = "/data/uniprot/uniref50/uniref50.fasta" #Base de datos por defecto
